...
- Stable `docs/releases/v0.6.4-proof.md` archive for the signed tag,
  ...
  browser acceptance, live monitor result, and final event-chain hash.
...
- **External staging verification proof mode** —
  ...
  with both image-push and Fly platform digests, and requires the
  LLM-authored prod proposal to cite it.
