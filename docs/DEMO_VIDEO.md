...
```bash
QUORUM_RELEASE_TAG=v0.6.8 scripts/capture_operator_proof.sh
```
...
- `release-proof-archive-ok: v0.6.8`
- `live-release-ok`
...
`docs/releases/v0.6.8-proof.md` against the signed tag object, tagged
